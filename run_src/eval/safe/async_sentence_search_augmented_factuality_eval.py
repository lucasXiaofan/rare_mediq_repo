...
from common import async_open_modeling #, modeling
...
def classify_relevance_and_rate_single(
    ...
    sentence: str,
    atomic_fact: str,
    rater: async_open_modeling.Model,
    best_rater: async_open_modeling.Model,
...
def main(prompt: str, response: str, rater: async_open_modeling.Model, best_rater: async_open_modeling.Model, split_fact: bool) -> dict[str, Any]:

...
best_model_short = 'gpt_4'
# model_short = 'command_r_plus_with_openai_api'
# best_model_short = 'command_r_plus_with_openai_api'
model_short = 'llama31_8b_with_openai_api'
# best_model_short = 'qwen72b_with_openai_api'
model_temp = 0.1
max_tokens = 512
...
best_model = shared_config.model_options[best_model_short]
